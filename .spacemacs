...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default "%I@%S")
   dotspacemacs-frame-title-format "%U@%S: %f | %n"
...
before packages are loaded."
  ...
  ;; make spaceline separators look better
  ...
  ;; Allows Paradox to show number of stars packages have
  ;; DO NOT SHARE NUMBER
  (setq paradox-github-token '740d11f134624f7ea8483a2d6c95e651643f7a64)

  ;; save current buffer when window focus is lost
  (defadvice switch-to-buffer (before save-buffer-now activate)
    (when buffer-file-name (save-buffer)))
  (defadvice other-window (before other-window-now activate)
    (when buffer-file-name (save-buffer)))

  ;; Switch 'j' and 'k' with 'jk' and 'kj'
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages
     (quote
      (ibuffer-projectile fringe-helper git-gutter+ git-gutter pos-tip flycheck magit magit-popup git-commit with-editor company inflections edn multiple-cursors paredit peg cider queue clojure-mode yasnippet auto-complete define-word ws-butler winum which-key wgrep volatile-highlights vi-tilde-fringe uuidgen use-package unfill toc-org symon string-inflection spaceline solarized-theme smex smeargle sayid reveal-in-osx-finder restart-emacs request rainbow-delimiters popwin persp-mode pcre2el pbcopy password-generator parinfer paradox osx-trash osx-dictionary org-plus-contrib org-bullets open-junk-file neotree mwim move-text magit-gitflow macrostep lorem-ipsum linum-relative link-hint launchctl ivy-purpose ivy-hydra info+ indent-guide hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation hide-comnt help-fns+ helm-make google-translate golden-ratio gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ fuzzy flycheck-pos-tip flx-ido fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu elisp-slime-nav editorconfig dumb-jump diff-hl counsel-projectile company-statistics column-enforce-mode clojure-snippets clj-refactor clean-aindent-mode cider-eval-sexp-fu browse-at-remote auto-yasnippet auto-highlight-symbol auto-compile aggressive-indent adaptive-wrap ace-window ace-link ac-ispell)))
